 ...
 *
 * <p>EMF pauses its animations whenever PAL is active. Better Combat's attack stack and PAL's
 * manager can stay active one or two frames longer than {@link BetterCombatCompat#getAttackHand}
