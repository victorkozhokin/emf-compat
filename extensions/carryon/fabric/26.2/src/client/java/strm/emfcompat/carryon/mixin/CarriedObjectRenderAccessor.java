...
public interface CarriedObjectRenderAccessor {
    ...
    /**
     * Carry On 2.11.0 (26.2) dropped the {@code BlockState} parameter — {@code drawBlock} now
     * looks the state up itself through {@code CarryRenderHelper.getRenderState}.
     */
    @Invoker("drawBlock")
    static void invokeDrawBlock(Player player, PoseStack poseStack, int light,
